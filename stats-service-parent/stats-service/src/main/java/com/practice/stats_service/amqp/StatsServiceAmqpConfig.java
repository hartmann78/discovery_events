...
@Configuration
public class StatsServiceAmqpConfig {
    ...
    @Bean
    public Binding statsBinding(Queue statsQueue, TopicExchange statsExchange, @Value("${events.service.routing-key}") String routingKey) {
